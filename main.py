...
if __name__ == "__main__":
    ...
    for BaseLanguage in BaseLanguages:
        ...
        svc_clf = classification_report(y_true, svc_pred, output_dict=True)
        ...
        rf_clf = classification_report(y_true, rf_pred,output_dict=True)
        ...
        voting_clf = classification_report(y_true, voting_pred)
